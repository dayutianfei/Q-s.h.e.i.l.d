...
public class AvroFlumeEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroFlumeEvent\",\"namespace\":\"cn.dayutianfei.loadserver.lib.avro.protocol\",\"fields\":[{\"name\":\"headers\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"body\",\"type\":\"bytes\"}]}");
  ...
  public static cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder newBuilder() {
    return new cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder();
  }
  
  /** Creates a new AvroFlumeEvent RecordBuilder by copying an existing Builder */
  public static cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder newBuilder(cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder other) {
    return new cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder(other);
  }
  
  /** Creates a new AvroFlumeEvent RecordBuilder by copying an existing AvroFlumeEvent instance */
  public static cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder newBuilder(cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent other) {
    return new cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroFlumeEvent>
    ...
    private Builder() {
      super(cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder other) {
      super(other);
    ...
    private Builder(cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent other) {
            super(cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.headers)) {
        this.headers = data().deepCopy(fields()[0].schema(), other.headers);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @param value the value to set.
      */
    public cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder setHeaders(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      */
    public cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder clearHeaders() {
      headers = null;
    ...
    /**
      ...
      * @param value the value to set.
      */
    public cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder setBody(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      */
    public cn.dayutianfei.loadserver.lib.avro.protocol.AvroFlumeEvent.Builder clearBody() {
      body = null;
