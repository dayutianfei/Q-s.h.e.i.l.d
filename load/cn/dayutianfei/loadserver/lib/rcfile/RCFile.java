...
public static class KeyBuffer implements WritableComparable {
  ...
  public static class Writer {
     ...
     * @throws
     */
    public Writer(FileSystem fs,Configuration conf,Path name,short replication,CompressionCodec codec)throws IOException{
        this(fs, conf, name, fs.getConf().getInt("io.file.buffer.size", 4096), replication,
                ShimLoader.getHadoopShims().getDefaultBlockSize(fs, name), null,
            new Metadata(), codec);
    }
    ...
    public void flushBlock(KeyBuffer keyBuffer, ValueBuffer valueBuffer,
        ...
        int compressedKeyLen) throws IOException {
